...
import { solveDp } from "../vendor/knapsack/src/dp.ts";
import { solveDpSoa } from "../vendor/knapsack/src/dp-soa.ts";
import type { ReducedGroup } from "../vendor/knapsack/src/types.ts";
